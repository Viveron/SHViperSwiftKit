...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SHViperSwiftKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Victor Shabanov/SHViperSwiftKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Victor Shabanov' => 'shabanov.dev.git@gmail.com' }
  s.source           = { :git => 'https://github.com/Victor Shabanov/SHViperSwiftKit.git', :tag => s.version.to_s }
